...
export class Databases extends Service {
    ...
    */
     ...
     * @returns {Promise}
    */
    async getUsage(range?: Range): Promise<Models.UsageDatabases> {
    ...
    */
     ...
     * @returns {Promise}
    */
    async getCollectionUsage(databaseId: string, collectionId: string, range?: Range): Promise<Models.UsageCollection> {
        if (typeof databaseId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "databaseId"');
        }
    ...
    */
     ...
     * @returns {Promise}
    */
    async getDatabaseUsage(databaseId: string, range?: Range): Promise<Models.UsageDatabase> {
        if (typeof databaseId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "databaseId"');
        }
