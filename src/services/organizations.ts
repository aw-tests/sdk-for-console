...
export class Organizations {
     ...
     */
    async listAddons(organizationId: string): Promise<Models.AddonList> {
        if (typeof organizationId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "organizationId"');
        }
     ...
     * @returns {Promise<{}>}
     */
    async createQuotaAddon(organizationId: string, key: string, quota: number): Promise<{}> {
        if (typeof organizationId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "organizationId"');
        }
        ...
        if (typeof quota === 'undefined') {
            throw new AppwriteException('Missing required parameter: "quota"');
        }
        const apiPath = '/organizations/{organizationId}/addons/quota'.replace('{organizationId}', organizationId);
        const payload: Payload = {};
        if (typeof key !== 'undefined') {
            payload['key'] = key;
        }
     ...
     * @returns {Promise<{}>}
     */
    async updateQuotaAddon(organizationId: string, addonId: string, quota: number): Promise<{}> {
        if (typeof organizationId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "organizationId"');
        }
        ...
        const apiPath = '/organizations/{organizationId}/addons/quota/{addonId}'.replace('{organizationId}', organizationId).replace('{addonId}', addonId);
        const payload: Payload = {};
        if (typeof quota !== 'undefined') {
            payload['quota'] = quota;
        }
     ...
     * @returns {Promise<{}>}
     */
    async createToggleAddon(organizationId: string, key: string): Promise<{}> {
        if (typeof organizationId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "organizationId"');
        }
        if (typeof key === 'undefined') {
        ...
        const apiPath = '/organizations/{organizationId}/addons/toggle'.replace('{organizationId}', organizationId);
        const payload: Payload = {};
        if (typeof key !== 'undefined') {
            payload['key'] = key;
        }
     ...
     * @returns {Promise<{}>}
     */
    async updateToggleAddon(organizationId: string, addonId: string, status: boolean): Promise<{}> {
        if (typeof organizationId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "organizationId"');
        }
        if (typeof addonId === 'undefined') {
        ...
        const apiPath = '/organizations/{organizationId}/addons/toggle/{addonId}'.replace('{organizationId}', organizationId).replace('{addonId}', addonId);
        const payload: Payload = {};
        if (typeof status !== 'undefined') {
     ...
     * @returns {Promise<Models.AddonList>}
     */
    async getAddon(organizationId: string, addonId: string): Promise<Models.AddonList> {
        if (typeof organizationId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "organizationId"');
        }
        if (typeof addonId === 'undefined') {
