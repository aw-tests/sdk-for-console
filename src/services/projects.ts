...
export class Projects extends Service {
    ...
    */
     ...
     * @returns {Promise}
    */
    async updateAuthStatus(projectId: string, method: Method, status: boolean): Promise<Models.Project> {
        if (typeof projectId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "projectId"');
        }
    ...
    */
     ...
     * @returns {Promise}
    */
    async updateOAuth2(projectId: string, provider: Provider, appId?: string, secret?: string, enabled?: boolean): Promise<Models.Project> {
        if (typeof projectId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "projectId"');
        }
    ...
    */
     ...
     * @returns {Promise}
    */
    async updateSmtpConfiguration(projectId: string, enabled: boolean, senderName?: string, senderEmail?: string, replyTo?: string, host?: string, port?: number, username?: string, password?: string, secure?: Secure): Promise<Models.Project> {
        if (typeof projectId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "projectId"');
        }
    ...
    */
     ...
     * @returns {Promise}
    */
    async getEmailTemplate(projectId: string, type: Type, locale: Locale): Promise<Models.EmailTemplate> {
        if (typeof projectId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "projectId"');
        }
     ...
     * @returns {Promise}
    */
    async updateEmailTemplate(projectId: string, type: Type, locale: Locale, subject: string, message: string, senderName?: string, senderEmail?: string, replyTo?: string): Promise<Models.Project> {
        if (typeof projectId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "projectId"');
        }
     ...
     * @returns {Promise}
    */
    async deleteEmailTemplate(projectId: string, type: Type, locale: Locale): Promise<Models.EmailTemplate> {
        if (typeof projectId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "projectId"');
        }
     ...
     * @returns {Promise}
    */
    async getSmsTemplate(projectId: string, type: Type, locale: Locale): Promise<Models.SmsTemplate> {
        if (typeof projectId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "projectId"');
        }
     ...
     * @returns {Promise}
    */
    async updateSmsTemplate(projectId: string, type: Type, locale: Locale, message: string): Promise<Models.SmsTemplate> {
        if (typeof projectId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "projectId"');
        }
     ...
     * @returns {Promise}
    */
    async deleteSmsTemplate(projectId: string, type: Type, locale: Locale): Promise<Models.SmsTemplate> {
        if (typeof projectId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "projectId"');
        }
     ...
     * @returns {Promise}
    */
    async getUsage(projectId: string, range?: Range): Promise<Models.UsageProject> {
        if (typeof projectId === 'undefined') {
            throw new AppwriteException('Missing required parameter: "projectId"');
        }
