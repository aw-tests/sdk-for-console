...
class Appwrite {
    ...
    database = {
         ...
         * @returns {Promise}
         */
        listCollections: async <T extends unknown>(search: string = '', limit: number = 25, offset: number = 0, orderType: string = 'ASC'): Promise<T> => {
    ...
    functions = {
         ...
         * @returns {Promise}
         */
        create: async <T extends unknown>(name: string, execute: string[], env: string, vars: object = {}, events: string[] = [], schedule: string = '', timeout: number = 15): Promise<T> => {
            if (name === undefined) {
                throw new AppwriteException('Missing required parameter: "name"');
            }
         ...
         * @returns {Promise}
         */
        update: async <T extends unknown>(functionId: string, name: string, execute: string[], vars: object = {}, events: string[] = [], schedule: string = '', timeout: number = 15): Promise<T> => {
            if (functionId === undefined) {
                throw new AppwriteException('Missing required parameter: "functionId"');
            }
         ...
         * @returns {Promise}
         */
        listTags: async <T extends unknown>(functionId: string, search: string = '', limit: number = 25, offset: number = 0, orderType: string = 'ASC'): Promise<T> => {
            if (functionId === undefined) {
                throw new AppwriteException('Missing required parameter: "functionId"');
            }
         ...
         * @returns {Promise}
         */
        getUsage: async <T extends unknown>(functionId: string, range: string = '30d'): Promise<T> => {
            if (functionId === undefined) {
                throw new AppwriteException('Missing required parameter: "functionId"');
            }
    ...
    projects = {
         ...
         * @returns {Promise}
         */
        getUsage: async <T extends unknown>(projectId: string, range: string = '30d'): Promise<T> => {
            if (projectId === undefined) {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
